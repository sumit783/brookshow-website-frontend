  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-white font-semibold hover-glow shadow-medium border-0",
        ticket: "bg-gradient-accent text-background font-semibold hover-glow shadow-medium border-0",
        glass: "glass text-foreground hover:bg-white/10 shadow-medium border border-white/20",
        join: "bg-gradient-secondary text-white font-semibold hover-glow shadow-strong px-8 py-4 text-base"
      },
      size: {
