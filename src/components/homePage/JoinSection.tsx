...
export const JoinSection = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-24 lg:py-32 md:px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto max-w-5xl text-center">
        <div className="glass-modern rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 shadow-strong fade-in-scale">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold font-heading mb-4 sm:mb-6 md:mb-8 bg-gradient-to-r from-white via-accent to-primary bg-clip-text text-transparent leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-8 justify-center items-stretch sm:items-center">
            <Button 
              variant="join" 
              size="xl" 
              className="pulse-glow w-full sm:w-auto min-w-[200px]" 
