    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2 bg-[#0a0a0a] overflow-hidden">
            <SEO 
                ...
                description="Join the elite BrookShow community. Create an account today and get exclusive access to world-class events."
                canonical="https://brookshow.com/signup"
            />
